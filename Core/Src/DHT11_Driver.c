...
int DHT11_Read_Data(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin, int *temp,
   ...
   * wait for low, then when it goes high, read the bit either 26-28ms or 50 if
   * it was high Data format: 8bit integral RH data + 8bit decimal RH data +
   * 8bit integral T data + 8bit decimal T data + 8bit check sum. If the data
   * transmission is right, the check-sum should be the last 8bit of "8bit
   * integral RH data + 8bit decimal RH data + 8bit integral T data + 8bit
   * decimal T data".
   */
